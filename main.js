...
const checkUsername = () => {
    ...
    if (isEmpty(username)) {
        ...
        //ERROR
        showError(usernameInput, `El nombre debe tener entre ${min} y ${max} caracteres`)
...
const checkPassword = () => {
    ...
    if (isEmpty(password)) {
        ...
        showError(passwordInput, 'La contraseña debe tener al menos 8 caracteres, una mayuscula, una minuscula y un simbolo.')
    } else {
